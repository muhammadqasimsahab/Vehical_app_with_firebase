...
class AddNewDriverPage extends StatefulWidget {
  AddNewDriverPage({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                UserNameTextFiled(
                  ...
                  hint: 'Phone',
                  icon: Icon(Icons.phone,color: _focusNodes[2].hasFocus ? AppColors.primaryColor : Colors.grey.shade300,),
                  visiable: false,
                ),
                    SizedBox(height: 3.h),
                UserNameTextFiled(
                  ...
                  hint: 'Email',
                  icon: Icon(Icons.email_outlined,color: _focusNodes[3].hasFocus ? AppColors.primaryColor : Colors.grey.shade300,),
                  visiable: false,
                ),
